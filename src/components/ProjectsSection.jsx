  ...
  return (
    <section id="projects" className="py-24 relative px-4">
      <div className="container mx-auto max-w-5xl">
        <h2 className="text-rxl md:text-4xl font-bold mb-4 text-center">
              ...
              <div className="p-6">
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-2 py-1 text-sm font-medium rounded-full bg-secondary text-secondary-foreground border bg-primary/30"
                    >
                      {tag}
                    </span>
                  ))}
